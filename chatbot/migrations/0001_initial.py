    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('elaborate', models.CharField(default=b'NULL', max_length=1000)),
                ('fblink', models.CharField(default=b'NULL', max_length=1000)),
                ('description', models.CharField(default=b'NULL', max_length=1000)),
                ('emailid', models.CharField(default=b'NULL', max_length=1000)),
                ('state', models.CharField(default=b'NULL', max_length=1000)),
                ('location', models.CharField(default=b'NULL', max_length=250)),
                ('twitterlink', models.CharField(default=b'NULL', max_length=250)),
                ('dob', models.CharField(default=b'NULL', max_length=1250)),
                ('githublink', models.CharField(default=b'NULL', max_length=250)),
                ('instagramlink', models.CharField(default=b'NULL', max_length=250)),
                ('displaypicture', models.CharField(default=b'NULL', max_length=250)),
                ('work1', models.CharField(default=b'NULL', max_length=1250)),
                ('work2', models.CharField(default=b'NULL', max_length=250)),
                ('work3', models.CharField(default=b'NULL', max_length=250)),
                ('work4', models.CharField(default=b'NULL', max_length=250)),
                ('name1', models.CharField(default=b'NULL', max_length=1250)),
                ('name2', models.CharField(default=b'NULL', max_length=250)),
                ('name3', models.CharField(default=b'NULL', max_length=250)),
                ('name4', models.CharField(default=b'NULL', max_length=250)),
                ('workdescribe1', models.CharField(default=b'NULL', max_length=1250)),
                ('workdescribe2', models.CharField(default=b'NULL', max_length=250)),
                ('workdescribe3', models.CharField(default=b'NULL', max_length=250)),
                ('workdescribe4', models.CharField(default=b'NULL', max_length=250)),
                ('cvlink', models.CharField(default=b'NULL', max_length=250)),
